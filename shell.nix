...
pkgs.mkShell {
  ...
  # Configure the Nix path to our own `pkgs`, to ensure Stack-with-Nix uses the correct one rather
  # than the global <nixpkgs> when looking for the right `ghc` argument to pass in 
